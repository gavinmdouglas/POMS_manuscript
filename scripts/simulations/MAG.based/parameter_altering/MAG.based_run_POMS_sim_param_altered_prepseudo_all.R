# Run POMS on parameter-altered simulation. Specifically meant for replicates where a pseudocount was added to the abundance of all taxa across all samples
# prior to the selection step. No pseudocount should be added during the POMS step.
...
null_out <- mclapply(X = parameter_settings, FUN = function(x) {
                     ...
                     func_sim_info <- readRDS(paste("sim_info_prepseudo/func_sim_info_",
                     ...
                     output <- POMS_pipeline(abun = func_sim_info$taxa_perturb_abun,
                                             ...
                                             ncores = 1,
                                             pseudocount = 0, ### Important to include for these tests.
                     ...
                     saveRDS(object = output,
                             file = paste("POMS_out_prepseudo/POMS_func_out_",
                                          "rep", as.character(rep_i),
                                          "_MAGs", as.character(MAG_num),
                                          "_prepseudo",
                                          "_increase", as.character(abun_increase_set),
