...
ggsave(filename = "~/github_repos/POMS_manuscript/figures/Maintext_ref.based_abun_and_ranking_POMS_vs_wilcoxon.pdf",
...
ggsave(filename = "~/github_repos/POMS_manuscript/figures/Maintext_ref.based_abun_and_ranking_POMS_vs_wilcoxon.png",
       plot = genome_prev_and_ranking_plot,
       device = "png",
       width = 8,
       height = 4,
