...
almeida_taxa <- readRDS(file = "taxonomy/taxa_table.rds")
...
ERP002061_sig_node_taxa_df <- data.frame(nodes = names(ERP002061_sig_node_taxa),
                                         taxa = ERP002061_sig_node_taxa,
                                         dir = ERP002061_sig_node_direction[names(ERP002061_sig_node_taxa)],
...
write.table(x = ERP002061_sig_node_taxa_df,
            file = "/home/gavin/github_repos/POMS_manuscript/display_items/Supp_obesity1_sig_node_taxa_table.tsv",
            sep = "\t",
            quote = FALSE,
            col.names = TRUE,
            row.names = FALSE)
