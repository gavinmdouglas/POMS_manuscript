...
ref.based_ranks_and_genome_nums_wilcoxon_nu0.50 <- ggplot(nu0.50_sim_func_summary, aes(y = num_focal_pos_mags, x = wilcoxon.musicc_rank_0.05)) +
...
ref.based_ranks_and_genome_nums_POMS_nu0.50 <- ggplot(nu0.50_sim_func_summary, aes(y = num_focal_pos_mags, x = POMS_rank_0.05)) +
...
ref.based_ranks_and_genome_nums_wilcoxon_nu0.65 <- ggplot(nu0.65_sim_func_summary, aes(y = num_focal_pos_mags, x = wilcoxon.musicc_rank_0.05)) +
                                                          geom_point(colour = "springgreen4", size = 2) +
                                                          theme_bw() +
                                                          xlab("") +
                                                          ylab("") +
...
ref.based_ranks_and_genome_nums_POMS_nu0.65 <- ggplot(nu0.65_sim_func_summary, aes(y = num_focal_pos_mags, x = POMS_rank_0.05)) +
                                                      geom_point(colour = "steelblue4", size = 2) +
                                                      theme_bw() +
                                                      xlab("Focal gene rank") +
                                                      ylab("") +
...
ref.based_ranks_and_genome_nums_wilcoxon_nu0.80 <- ggplot(nu0.80_sim_func_summary, aes(y = num_focal_pos_mags, x = wilcoxon.musicc_rank_0.05)) +
                                                          geom_point(colour = "springgreen4", size = 2) +
                                                          theme_bw() +
                                                          xlab("") +
                                                          ylab("") +
...
ref.based_ranks_and_genome_nums_POMS_nu0.80 <- ggplot(nu0.80_sim_func_summary, aes(y = num_focal_pos_mags, x = POMS_rank_0.05)) +
                                                      geom_point(colour = "steelblue4", size = 2) +
                                                      theme_bw() +
                                                      xlab("Focal gene rank") +
                                                      ylab("") +
...
ref.based_ranks_and_genome_nums_wilcoxon_nu0.95 <- ggplot(nu0.95_sim_func_summary, aes(y = num_focal_pos_mags, x = wilcoxon.musicc_rank_0.05)) +
                                                          geom_point(colour = "springgreen4", size = 2) +
                                                          theme_bw() +
                                                          xlab("") +
                                                          ylab("") +
...
ref.based_ranks_and_genome_nums_POMS_nu0.95 <- ggplot(nu0.95_sim_func_summary, aes(y = num_focal_pos_mags, x = POMS_rank_0.05)) +
                                                      geom_point(colour = "steelblue4", size = 2) +
                                                      theme_bw() +
                                                      xlab("Focal gene rank") +
                                                      ylab("") +
...
ggsave(filename = "~/github_repos/POMS_manuscript/display_items/Supp_ref.based_sims_ranking.pdf",
...
ggsave(filename = "~/github_repos/POMS_manuscript/display_items/Supp_ref.based_sims_ranking.png",
       plot = ref.based_ranks_and_genome_nums_plots,
       device = "png",
       width = 12,
       height = 6,
